 ...
 */
function onUnauthorisedResponse(refreshTokenUrl, preRequestIdToken, websiteRootDomain) {
    return __awaiter(this, void 0, void 0, function() {
        var lock, postLockID, response, idRefreshToken, error_1, idCookieValue;
...
function setIDToCookie(idRefreshToken, domain) {
    ...
    var cookieVal = splitted[0];
    var expires = new Date(Number(splitted[1])).toUTCString();
