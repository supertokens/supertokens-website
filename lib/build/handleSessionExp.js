 ...
 */
function onUnauthorisedResponse(refreshTokenUrl, preRequestIdToken, websiteRootDomain, refreshAPICustomHeaders, sessionExpiredStatusCode) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, _1.default.originalFetch(refreshTokenUrl, {
                                            method: "post",
                                            credentials: "include",
                                            headers: __assign({}, refreshAPICustomHeaders, { "supertokens-sdk-name": "website", "supertokens-sdk-version": version_1.package_version })
                                        })];
                                case 3:
                                    response = _a.sent();
