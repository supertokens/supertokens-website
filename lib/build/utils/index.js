...
function validateAndNormaliseInputOrThrowError(options) {
    ...
    var sessionScope = normaliseSessionScopeOrThrowError(options !== undefined && options.sessionScope !== undefined ? options.sessionScope : defaultSessionScope);
    ...
    var preAPIHook = function (context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var postAPIHook = function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/];
    }); }); };
    ...
    var override = __assign({ functions: function (oI) { return oI; } }, options.override);
...
function shouldDoInterceptionBasedOnUrl(toCheckUrl, apiDomain, cookieDomain) {
    (0, logger_1.logDebugMessage)("shouldDoInterceptionBasedOnUrl: toCheckUrl: " +
        toCheckUrl +
        " apiDomain: " +
        apiDomain +
        " cookiDomain: " +
