...
var DateProviderReference = /** @class */ (function () {
    function DateProviderReference(dateProviderInput) {
        ...
        if (dateProviderInput !== undefined) {
            ...
            var localStorage_1 = windowHandler_1.default.getReferenceOrThrow().windowHandler.localStorage;
            var clockSkewInMillis = parseInt(
                localStorage_1.getItemSync(defaultImplementation_1.DateProvider.CLOCK_SKEW_KEY) || "0",
                10
            );
