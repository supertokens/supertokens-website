                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            _a.label = 3;
                        case 3: return [2 /*return*/, body.claimValidationErrors];
                    }
                });
            });
        },
        ...
        validateClaims: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, this.getAccessTokenPayloadSecurely({ userContext: input.userContext })];
                        case 1:
                        ...
                        case 6:
                            ...
                            return [3 /*break*/, 7];
                        case 7: return [4 /*yield*/, this.getAccessTokenPayloadSecurely({ userContext: input.userContext })];
                        case 8:
                            accessTokenPayload = _d.sent();
                            _d.label = 9;
                        case 9:
                        ...
                        case 13:
                            _b++;
                            return [3 /*break*/, 11];
                        case 14: return [2 /*return*/, errors];
                    }
                });
            });
        }
