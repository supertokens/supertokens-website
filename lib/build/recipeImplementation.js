...
var RecipeImplementation = /** @class */ (function () {
    function RecipeImplementation() {
        ...
        this.addFetchInterceptorsAndReturnModifiedFetch = function (originalFetch, _) {
            return function (url, config) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch_1.default.doRequest(function (config) {
        ...
        this.addAxiosInterceptors = function (axiosInstance, _) {
            ...
            axiosInstance.interceptors.response.use(axios_1.responseInterceptor(axiosInstance), axios_1.responseErrorInterceptor(axiosInstance));
        };
        this.getUserId = function (_) { return __awaiter(_this, void 0, void 0, function () {
            var tokenInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch_1.FrontToken.getTokenInfo()];
                    case 1:
                        tokenInfo = _a.sent();
        ...
        this.getJWTPayloadSecurely = function (config) { return __awaiter(_this, void 0, void 0, function () {
            var tokenInfo, retry;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch_1.FrontToken.getTokenInfo()];
                    ...
                    case 4: throw new Error("Could not refresh session");
                    case 5: return [2 /*return*/, tokenInfo.up];
                }
            });
        }); };
        this.doesSessionExist = function (_) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch_1.getIdRefreshToken(true)];
                    case 1: return [2 /*return*/, (_a.sent()).status === "EXISTS"];
                }
            });
        }); };
        this.signOut = function (config) { return __awaiter(_this, void 0, void 0, function () {
            var preAPIResult, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.doesSessionExist(config)];
                    case 1:
                        if (!(_a.sent())) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, config.preAPIHook({
                                action: "SIGN_OUT",
                                requestInit: {
                                    method: "post",
                                    headers: {
