...
var RecipeImplementation = /** @class */ (function() {
    function RecipeImplementation() {
        var _this = this;
        this.addFetchInterceptors = function(env, originalFetch) {
        ...
        this.addAxiosInterceptors = function(axiosInstance) {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.attemptRefreshingSession()];
                        case 2:
                            retry = _a.sent();
        ...
        this.attemptRefreshingSession = function() {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            return [2 /*return*/, _a.sent()];
                        case 3:
                            return [4 /*yield*/, this.doesSessionExist()];
                        case 4:
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                fetch(fetch_1.default.signOutUrl, {
                                    ...
                                    credentials: "include",
                                    headers:
                                        fetch_1.default.signoutAPICustomHeaders === undefined
                                            ? undefined
                                            : __assign({}, fetch_1.default.signoutAPICustomHeaders)
                                })
                            ];
                        case 2:
                            resp = _a.sent();
                            if (resp.status === fetch_1.default.sessionExpiredStatusCode) {
                                return [2 /*return*/];
                            }
                            if (resp.status >= 300) {
                                throw resp;
