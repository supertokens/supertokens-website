 ...
 */
function handleUnauthorised(refreshAPI, preRequestIdToken, websiteRootDomain) {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        handleSessionExp_1.onUnauthorisedResponse(refreshAPI, preRequestIdToken, websiteRootDomain)
                    ];
                case 1:
                    result = _a.sent();
...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(refreshTokenUrl, sessionExpiredStatusCode, viaInterceptor, websiteRootDomain) {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (
                            preRequestIdToken !== undefined &&
                            (config === undefined || config.credentials === undefined)
                        ) {
