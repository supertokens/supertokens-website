...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.setAuth0API = function(apiPath) {
        return fetch_1.default.setAuth0API(apiPath);
    };
    AuthHttpRequest.getUserId = function() {
        return fetch_1.default.getUserId();
    };
    AuthHttpRequest.getJWTPayloadSecurely = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                return [2 /*return*/, fetch_1.default.getJWTPayloadSecurely()];
            });
        });
    };
    AuthHttpRequest.getAuth0API = function() {
        return fetch_1.default.getAuth0API();
    };
    AuthHttpRequest.getRefreshURLDomain = function() {
        return fetch_1.default.getRefreshURLDomain();
    };
    /**
    ...
    AuthHttpRequest.doesSessionExist = function() {
        return fetch_1.default.doesSessionExist();
    };
    AuthHttpRequest.addAxiosInterceptors = function(axiosInstance) {
        return axios_1.default.addAxiosInterceptors(axiosInstance);
    };
    AuthHttpRequest.signOut = function() {
        return fetch_1.default.signOut();
    };
    return AuthHttpRequest;
})();
exports.default = AuthHttpRequest;
exports.init = AuthHttpRequest.init;
exports.setAuth0API = AuthHttpRequest.setAuth0API;
exports.getAuth0API = AuthHttpRequest.getAuth0API;
exports.getRefreshURLDomain = AuthHttpRequest.getRefreshURLDomain;
