...
var AntiCsrfToken = /** @class */ (function() {
    ...
    AntiCsrfToken.getToken = function(associatedIdRefreshToken) {
        ...
        if (AntiCsrfToken.tokenInfo === undefined) {
            var antiCsrf = getAntiCSRFromCookie(AuthHttpRequest.websiteRootDomain);
            if (antiCsrf === null) {
                return undefined;
            }
...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(options) {
        var refreshTokenUrl = options.refreshTokenUrl,
            ...
            viaInterceptor = options.viaInterceptor,
...
function getAntiCSRFromCookie(domain) {
    ...
    var fromLocalstorage = window.localStorage.getItem("anti-csrf-localstorage");
