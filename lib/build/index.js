 ...
 */
function handleUnauthorised(refreshAPI, preRequestIdToken, websiteRootDomain, refreshAPICustomHeaders, sessionExpiredStatusCode) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, handleSessionExp_1.onUnauthorisedResponse(refreshAPI, preRequestIdToken, websiteRootDomain, refreshAPICustomHeaders, sessionExpiredStatusCode)];
                case 1:
                    result = _a.sent();
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (refreshTokenUrl, sessionExpiredStatusCode, viaInterceptor, websiteRootDomain, refreshAPICustomHeaders) {
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    configWithAntiCsrf = __assign({}, configWithAntiCsrf, { headers: configWithAntiCsrf === undefined
                            ...
                            : __assign({}, configWithAntiCsrf.headers, { "supertokens-sdk-name": "website", "supertokens-sdk-version": version_1.package_version }) });
                    _a.label = 5;
                case 5:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, handleUnauthorised(AuthHttpRequest.refreshTokenUrl, preRequestIdToken, AuthHttpRequest.websiteRootDomain, AuthHttpRequest.refreshAPICustomHeaders, AuthHttpRequest.sessionExpiredStatusCode)];
                case 7:
                    retry = _a.sent();
                    if (!retry) {
                        returnObj = response;
