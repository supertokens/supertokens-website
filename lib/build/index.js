...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.getInvalidClaimsFromResponse = function(response) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                return [2 /*return*/, fetch_1.default.recipeImpl.getInvalidClaimsFromResponse({ response: response })];
            });
        });
    };
    AuthHttpRequest.validateClaims = function(claimValidators, userContext) {
        return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a) {
                return [
                    2 /*return*/,
                    fetch_1.default.recipeImpl.validateClaims({
