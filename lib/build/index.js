...
exports.BooleanClaim = exports.PrimitiveArrayClaim = exports.PrimitiveClaim = exports.SessionClaimValidator = exports.getInvalidClaimsFromResponse = exports.getClaimValue = exports.validateClaims = exports.signOut = exports.addAxiosInterceptors = exports.doesSessionExist = exports.attemptRefreshingSession = exports.getAccessTokenPayloadSecurely = exports.getUserId = exports.init = void 0;
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (options) {
        ...
        lockFactory_1.LockFactoryReference.init(options.lockFactory);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        userContext = (0, utils_1.getNormalisedUserContext)(input === undefined ? undefined : input.userContext);
                        return [4 /*yield*/, AuthHttpRequest.getAccessTokenPayloadSecurely({ userContext: userContext })];
                    case 1:
    ...
    AuthHttpRequest.validateClaims = function (overrideGlobalClaimValidators, userContext) {
        ...
        var claimValidators = overrideGlobalClaimValidators !== undefined
...
Object.defineProperty(exports, "SessionClaimValidator", { enumerable: true, get: function () { return types_1.SessionClaimValidator; } });
