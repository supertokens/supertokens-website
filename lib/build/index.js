...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.claimValidatorsAddedByOtherRecipes = [];
    AuthHttpRequest.axiosInterceptorQueue = [];
    ...
    AuthHttpRequest.getInvalidClaimsFromResponse = function(response, userContext) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                return [
                    2 /*return*/,
    ...
    AuthHttpRequest.validateClaims = function(overrideGlobalClaimValidators, userContext) {
        var normalisedUserContext = utils_1.getNormalisedUserContext(userContext);
        var claimValidatorsAddedByOtherRecipes = AuthHttpRequest.getClaimValidatorsAddedByOtherRecipes();
    ...
    AuthHttpRequest.addClaimValidatorFromOtherRecipe = function(builder) {
        AuthHttpRequest.claimValidatorsAddedByOtherRecipes.push(builder);
    };
    AuthHttpRequest.getClaimValidatorsAddedByOtherRecipes = function() {
...
exports.SessionClaimValidator = types_1.SessionClaimValidator;
