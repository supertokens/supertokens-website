...
var cookieHandling_1 = require("./common/cookieHandling");
...
function validateAndNormaliseInputOrThrowError(options) {
    ...
    var defaultSessionScope =
        windowUtils_1.WindowUtilities.location.hostname === ""
            ? "localhost"
            : windowUtils_1.WindowUtilities.location.hostname;
    ...
    var cookieHandler = function(original) {
        return original;
    };
...
function normaliseCookieHandler(cookieHandlerInput) {
    if (cookieHandlerInput !== undefined) {
        return cookieHandlerInput(cookieHandling_1.defaultCookieHandler);
    }
    return cookieHandling_1.defaultCookieHandler;
}
exports.normaliseCookieHandler = normaliseCookieHandler;
