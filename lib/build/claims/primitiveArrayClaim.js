    ...
    function PrimitiveArrayClaim(config) {
        ...
        this.validators = {
            includes: function (val, maxAgeInSeconds, id) {
                if (maxAgeInSeconds === void 0) { maxAgeInSeconds = _this.defaultMaxAgeInSeconds; }
                return {
                    id: id !== undefined ? id : _this.id,
                    refresh: function (ctx) { return _this.refresh(ctx); },
                    ...
                    validate: function (payload, ctx) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return {
                    ...
                    validate: function (payload, ctx) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            isValid = val.every(function (v) { return claimSet.has(v); });
