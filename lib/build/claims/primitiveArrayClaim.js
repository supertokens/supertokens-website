    ...
    function PrimitiveArrayClaim(config) {
        ...
        this.validators = {
            includes: function(val, maxAgeInSeconds, id) {
                return {
                    id: id !== undefined ? id : _this.id + "-includes",
            ...
            excludes: function(val, maxAgeInSeconds, id) {
                return {
                    id: id !== undefined ? id : _this.id + "-excludes",
                    refresh: function(ctx) {
                        return _this.refresh(ctx);
                    },
                    shouldRefresh: function(payload, ctx) {
            ...
            includesAll: function(val, maxAgeInSeconds, id) {
                return {
                    id: id !== undefined ? id : _this.id + "-includesAll",
                    refresh: function(ctx) {
                        return _this.refresh(ctx);
                    },
                    shouldRefresh: function(payload, ctx) {
            ...
            excludesAll: function(val, maxAgeInSeconds, id) {
                return {
                    id: id !== undefined ? id : _this.id + "excludesAll",
                    refresh: function(ctx) {
                        return _this.refresh(ctx);
                    },
                    shouldRefresh: function(payload, ctx) {
            ...
            strictEquals: function(val, maxAgeInSeconds, id) {
                return {
                    id: id !== undefined ? id : _this.id + "-strictEquals",
                    refresh: function(ctx) {
                        return _this.refresh(ctx);
                    },
                    shouldRefresh: function(payload, ctx) {
                    ...
                    validate: function(payload, ctx) {
                        return __awaiter(_this, void 0, void 0, function() {
                            var claimVal, ageInSeconds, _i, _a, _b, i, v;
                            return __generator(this, function(_c) {
                                ...
                                for (_i = 0, _a = Array.from(val.entries()); _i < _a.length; _i++) {
