...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(refreshTokenUrl, sessionExpiredStatusCode, websiteRootDomain) {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (
                            ...
                            (config === undefined || config.withCredentials === undefined)
                        ) {
                            config = __assign({}, config, { withCredentials: true });
                        }
                        configWithAntiCsrf = config;
    ...
    AuthHttpRequest.makeSuper = function(axiosInstance) {
        ...
        axiosInstance.interceptors.response.use(
            function(response) {
                return __awaiter(this, void 0, void 0, function() {
                    var idRefreshToken, config, antiCsrfToken;
                    return __generator(this, function(_a) {
                        try {
                            if (!AuthHttpRequest.initCalled) {
