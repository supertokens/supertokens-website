            ...
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        doNotDoInterception =
                            typeof url === "string" &&
                                !utils_1.shouldDoInterceptionBasedOnUrl(url, fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain);
                    }
                    catch (err) {
                        if (err.message === "Please provide a valid domain name") {
                            // .origin gives the port as well..
                            doNotDoInterception = !utils_1.shouldDoInterceptionBasedOnUrl(window.location.origin, fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain);
                        }
                        else {
                            throw err;
                        }
...
function responseErrorInterceptor(axiosInstance) {
    return function (error) {
        if (error.response !== undefined &&
            ...
            return AuthHttpRequest.doRequest(function (config) {
                // we create an instance since we don't want to intercept this.
                // const instance = axios.create();
                // return instance(config);
                return axiosInstance(config);
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.doRequest = function (httpCall, config, url, prevResponse, prevError, viaInterceptor) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            var doNotDoInterception, throwError, returnObj, preRequestIdToken, configWithAntiCsrf, antiCsrfToken, localPrevError, localPrevResponse, response, _a, idRefreshToken, retry, antiCsrfToken, tok, frontToken, err_1, retry;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!fetch_1.default.initCalled) {
                        ...
                        try {
                            ...
                            if (err.message === "Please provide a valid domain name") {
                                // .origin gives the port as well..
                                doNotDoInterception =
                                    !utils_1.shouldDoInterceptionBasedOnUrl(window.location.origin, fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain) && viaInterceptor;
                            }
                            else {
                                throw err;
                            }
                    ...
                    case 11:
                        ...
                        _b.label = 12;
                    case 12:
                        if (!(response.status === fetch_1.default.config.sessionExpiredStatusCode)) return [3 /*break*/, 14];
                        return [4 /*yield*/, fetch_1.handleUnauthorised(preRequestIdToken)];
                    case 13:
                        retry = _b.sent();
                        if (!retry) {
                            returnObj = response;
                    ...
                    case 21:
                        ...
                        if (!(err_1.response !== undefined &&
                            err_1.response.status === fetch_1.default.config.sessionExpiredStatusCode)) return [3 /*break*/, 23];
                        return [4 /*yield*/, fetch_1.handleUnauthorised(preRequestIdToken)];
                    case 22:
                        retry = _b.sent();
                        if (!retry) {
                    ...
                    case 26:
                        ...
                        return [3 /*break*/, 32];
                    case 27: return [4 /*yield*/, fetch_1.default.recipeImpl.doesSessionExist(fetch_1.default.config)];
                    case 28:
