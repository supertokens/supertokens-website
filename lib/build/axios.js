            ...
            return __generator(this, function(_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [
                            4 /*yield*/,
                            fetch_1.default.recipeImpl.getInvalidClaimsFromResponse({ response: response })
                        ];
                    case 5:
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [
                            4 /*yield*/,
                            fetch_1.default.recipeImpl.getInvalidClaimsFromResponse({ response: error.response })
                        ];
                    case 2:
