        ...
        return __awaiter(_this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        if (response.status === fetch_1.default.config.missingClaimStatusCode) {
                            fetch_1.onMissingClaimResponse(response.headers["missing-claim-id"]);
                        }
    ...
    return function(error) {
        ...
        if (error.response !== undefined && error.response.status === fetch_1.default.config.sessionExpiredStatusCode) {
            ...
            if (
                ...
                error.response.status === fetch_1.default.config.missingClaimStatusCode
            ) {
                fetch_1.onMissingClaimResponse(error.response.headers["missing-claim-id"]);
            }
            throw error;
        }
    };
