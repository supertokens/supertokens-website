            ...
            return __generator(_a, function(_g) {
                switch (_g.label) {
                    ...
                    case 20:
                        if (!(response.status === fetch_1.default.config.invalidClaimStatusCode))
                            return [3 /*break*/, 22];
                        _d = fetch_1.onInvalidClaimResponse;
                        return [
                            4 /*yield*/,
                            fetch_1.default.recipeImpl.getInvalidClaimsFromResponse({
                                response: response,
                    ...
                    case 37:
                        if (!(response.status === fetch_1.default.config.invalidClaimStatusCode))
                            return [3 /*break*/, 39];
                        _f = fetch_1.onInvalidClaimResponse;
                        return [
                            4 /*yield*/,
                            fetch_1.default.recipeImpl.getInvalidClaimsFromResponse({
                                response: response,
