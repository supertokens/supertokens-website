...
function interceptorFunctionRequestFulfilled(config) {
    return __awaiter(this, void 0, void 0, function() {
        var url, doNotDoInterception, preRequestLSS, configWithAntiCsrf, antiCsrfToken;
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    ...
                    (0,
                    logger_1.logDebugMessage)("setTokenHeadersIfRequired: Adding st-auth-mode header: " + transferMethod);
