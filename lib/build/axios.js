        ...
        return __generator(this, function(_a) {
            ...
            try {
                ...
                if (err.message === "Please provide a valid domain name") {
                    ...
                    doNotDoInterception =
                        utils_1.normaliseURLDomainOrThrowError(window.location.origin) !== fetch_1.default.apiDomain;
                } else {
                    throw err;
                }
            }
            ...
            preRequestIdToken = fetch_1.getIdRefreshToken();
...
function responseInterceptor(axiosInstance) {
    ...
    return function(response) {
        return __awaiter(_this, void 0, void 0, function() {
            var url, doNotDoInterception, idRefreshToken, config, antiCsrfToken, frontToken;
            return __generator(this, function(_a) {
                try {
                    ...
                    if (idRefreshToken !== undefined) {
                        fetch_1.setIdRefreshToken(idRefreshToken);
                    }
                    if (response.status === fetch_1.default.sessionExpiredStatusCode) {
                        ...
                        if (antiCsrfToken !== undefined) {
                            fetch_1.AntiCsrfToken.setItem(fetch_1.getIdRefreshToken(), antiCsrfToken);
                        }
                    ...
                    if (fetch_1.getIdRefreshToken() === undefined) {
                ...
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        if (antiCsrfToken_1 !== undefined) {
                            fetch_1.AntiCsrfToken.setItem(fetch_1.getIdRefreshToken(), antiCsrfToken_1);
                        }
                        frontToken = response.headers["front-token"];
                        if (frontToken !== undefined) {
                            fetch_1.FrontToken.setItem(frontToken);
