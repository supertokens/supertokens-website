            ...
            return __generator(this, function(_a) {
                try {
                    ...
                    if (idRefreshToken !== undefined) {
                        _1.setIDToCookie(idRefreshToken, AuthHttpRequest.websiteRootDomain);
                    }
...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.setAuth0API = function(apiPath) {
        _1.default.setAuth0API(apiPath);
    };
    AuthHttpRequest.init = function(options) {
        var refreshTokenUrl = options.refreshTokenUrl,
            websiteRootDomain = options.websiteRootDomain,
        ...
        _1.default.init(__assign({}, options, { viaInterceptor: null }));
    ...
    AuthHttpRequest.autoAddCredentials = true;
    /**
    ...
    AuthHttpRequest.doesSessionExist = function() {
        return _1.getIDFromCookie() !== undefined;
    };
