...
function interceptorFunctionRequestFulfilled(config) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            ...
            if (typeof url === "string" && fetch_1.getDomainFromUrl(url) !== fetch_1.default.apiDomain) {
            ...
            return __generator(this, function(_a) {
                try {
                    ...
                    if (idRefreshToken !== undefined) {
                        fetch_1.setIDToCookie(idRefreshToken, fetch_1.default.websiteRootDomain);
                    }
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (
                            !(
                                typeof url === "string" &&
                                fetch_1.getDomainFromUrl(url) !== fetch_1.default.apiDomain &&
                                viaInterceptor
                            )
                        )
                            return [3 /*break*/, 2];
                    ...
                    case 7:
                        ...
                        return [
                            ...
                            fetch_1.handleUnauthorised(
                                ...
                                preRequestIdToken,
                                fetch_1.default.websiteRootDomain,
