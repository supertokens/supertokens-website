        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                    ...
                    try {
                        doNotDoInterception =
                            ...
                            !(0, utils_1.shouldDoInterceptionBasedOnUrl)(
                                ...
                                fetch_1.default.config.sessionDomain
                            );
                    } catch (err) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch_1.AntiCsrfToken.getToken(preRequestIdToken.lastRefreshAttempt)];
                case 2:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, setTokenHeaders(configWithAntiCsrf)];
                case 4:
                    _a.sent();
            ...
            return __generator(_a, function(_e) {
                switch (_e.label) {
                    ...
                    case 24:
                        ...
                        if (!(response !== undefined)) return [3 /*break*/, 35];
                        return [4 /*yield*/, saveTokensFromHeaders(response)];
                    case 25:
                        _e.sent();
                        (0,
                    ...
                    case 40:
                        ...
                        if (!(postRequestIdToken.status === "NOT_EXISTS")) return [3 /*break*/, 43];
                        (0,
...
function setTokenHeaders(requestConfig) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    ...
                    (0, logger_1.logDebugMessage)("setTokenHeaders: adding header preference to rid header");
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, fetch_1.getToken)("refresh")];
                case 2:
