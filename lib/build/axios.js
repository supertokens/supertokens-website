...
function interceptorFunctionRequestFulfilled(config) {
    return __awaiter(this, void 0, void 0, function() {
        var url, doNotDoInterception, preRequestLSS, configWithAntiCsrf, antiCsrfToken, transferMethod, accessToken;
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    accessToken = (0, fetch_1.getTokenForHeaderAuth)("access");
                    if (accessToken !== undefined) {
                        if (configWithAntiCsrf.headers.authorization === "Bearer ".concat(accessToken)) {
                            (0, logger_1.logDebugMessage)(
