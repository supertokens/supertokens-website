...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (refreshTokenUrl, sessionExpiredStatusCode, websiteRootDomain, refreshAPICustomHeaders) {
    ...
    AuthHttpRequest.doRequest = function (httpCall, config, url, prevResponse, prevError, viaInterceptor) {
        ...
        return __awaiter(_this, void 0, void 0, function () {
            var throwError, returnObj, preRequestIdToken, antiCsrfToken, configWithAntiCsrf, localPrevError, localPrevResponse, response, _a, idRefreshToken, retry, antiCsrfToken_1, err_1, retry;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(typeof url === "string" && _1.getDomainFromUrl(url) !== AuthHttpRequest.apiDomain && viaInterceptor)) return [3 /*break*/, 2];
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, _1.handleUnauthorised(AuthHttpRequest.refreshTokenUrl, preRequestIdToken, AuthHttpRequest.websiteRootDomain, AuthHttpRequest.refreshAPICustomHeaders, AuthHttpRequest.sessionExpiredStatusCode)];
                    case 8:
                        retry = _b.sent();
                        if (!retry) {
                            returnObj = response;
