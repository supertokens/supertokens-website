            ...
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        doNotDoInterception =
                            typeof url === "string" &&
                                !(0, utils_1.shouldDoInterceptionBasedOnUrl)(url, fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain);
                    }
                    catch (err) {
                ...
                case 2:
                    ...
                    if (antiCsrfToken !== undefined) {
                        ...
                        configWithAntiCsrf = __assign(__assign({}, configWithAntiCsrf), { headers: configWithAntiCsrf === undefined
                                ? {
                ...
                case 1:
                    ...
                    try {
                        ...
                        if (err.message === "Please provide a valid domain name") {
                            ...
                            // .origin gives the port as well..
                            doNotDoInterception =
                                !(0, utils_1.shouldDoInterceptionBasedOnUrl)(windowHandler_1.default.getReferenceOrThrow().windowHandler.location.getOrigin(), fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain) || !!response.headers["x-supertokens-xhr-intercepted"];
                        }
                        else {
                            throw err;
                        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, logger_1.logDebugMessage)("responseErrorInterceptor: already intercepted: " +
                    ...
                    if (!(error.response !== undefined &&
                        error.response.status === fetch_1.default.config.sessionExpiredStatusCode)) return [3 /*break*/, 1];
                ...
                case 1:
                    if (!(error.response !== undefined &&
                        error.response.status === fetch_1.default.config.invalidClaimStatusCode)) return [3 /*break*/, 3];
            ...
            return __generator(_a, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        try {
                            ...
                            if (err.message === "Please provide a valid domain name") {
                                ...
                                // .origin gives the port as well..
                                doNotDoInterception =
                                    !(0, utils_1.shouldDoInterceptionBasedOnUrl)(windowHandler_1.default.getReferenceOrThrow().windowHandler.location.getOrigin(), fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain) && viaInterceptor;
                            }
                            else {
                                throw err;
                            }
                    ...
                    case 15:
                        _c = _e.sent();
                        return [3 /*break*/, 18];
                    case 16: return [4 /*yield*/, (0, axiosError_1.createAxiosErrorFromAxiosResp)(response)];
                    case 17:
                        _c = _e.sent();
                        _e.label = 18;
                    case 18:
