            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (
                        ...
                        (0, logger_1.logDebugMessage)(
                            "setAuthorizationHeaderIfRequired: Adding st-auth-mode header: " + transferMethod
                        );
                        xhr.setRequestHeader("st-auth-mode", transferMethod);
                    } else {
                        (0, logger_1.logDebugMessage)(
                            "setAuthorizationHeaderIfRequired: st-auth-mode header was already there in request"
                        );
                    }
