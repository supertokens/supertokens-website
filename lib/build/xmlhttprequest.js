...
function addInterceptorsToXMLHttpRequest() {
    ...
    setTimeout(function () { return (firstEventLoopDone = true); }, 0);
    ...
    XMLHttpRequest = function () {
        ...
        function redispatchEvent(name, ev) {
            ...
            if (handlers) {
                Array.from(handlers).forEach(function (handler) { return handler.apply(self, [ev]); });
            }
        }
        ...
        self.open = function (_, u) {
            ...
            try {
                doNotDoInterception =
                    (typeof url === "string" &&
                        ...
                        (typeof url !== "string" &&
                            !(0, utils_1.shouldDoInterceptionBasedOnUrl)(url.toString(), fetch_1.default.config.apiDomain, fetch_1.default.config.cookieDomain));
            }
            catch (err) {
            ...
            delayIfNecessary(function () { return actual.open.apply(actual, args); });
        };
        ...
        self.setRequestHeader = function (name, value) {
            if (doNotDoInterception) {
                delayIfNecessary(function () { return actual.setRequestHeader(name, value); });
                return;
            }
        ...
        function setUpXHR(self, xhr, isRetry) {
            ...
            self.getAllResponseHeaders = function () {
                ...
                if (customResponseHeaders) {
                    headersString = "";
                    customResponseHeaders.forEach(function (v, k) { return (headersString += "".concat(k, ": ").concat(v, "\r\n")); });
                }
                else {
        ...
        function sendXHR(xhr, body) {
            ...
            if (doNotDoInterception) {
                ...
                delayIfNecessary(function () { return xhr.send(body); });
                return;
            }
            ...
            delayIfNecessary(function () { return __awaiter(_this, void 0, void 0, function () {
                var antiCsrfToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, fetch_1.getIdRefreshToken)(true)];
                        case 1:
                        ...
                        case 3:
                            ...
                            if (!requestHeaders.some(function (i) { return i.name === "rid"; })) {
