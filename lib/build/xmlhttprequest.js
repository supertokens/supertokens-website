...
exports.removeXMLHttpRequestInterceptor = exports.addInterceptorsToXMLHttpRequest = void 0;
...
function addInterceptorsToXMLHttpRequest() {
    ...
    XMLHttpRequest = function() {
        ...
        function handleResponse(xhr) {
            return __awaiter(this, void 0, void 0, function() {
                var doFinallyCheck, status_1, idRefreshToken, antiCsrfToken, tok, frontToken, err_1, resp, event_1;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 22, , 26]);
                            doFinallyCheck = true;
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, , 16, 21]);
                        ...
                        case 6:
                            if (!(status_1 < 400)) return [3 /*break*/, 14];
                        ...
                        case 15:
                            return [2 /*return*/, true];
                        case 16:
                            if (!doFinallyCheck) return [3 /*break*/, 20];
                        ...
                        case 17:
                            if (!!(_a.sent().status === "EXISTS")) return [3 /*break*/, 20];
                            (0,
                        ...
                        case 22:
                            ...
                            if (!(err_1.status !== undefined)) return [3 /*break*/, 24];
...
function removeXMLHttpRequestInterceptor() {
    XMLHttpRequest = XMLHttpRequest.__original;
}
exports.removeXMLHttpRequestInterceptor = removeXMLHttpRequestInterceptor;
