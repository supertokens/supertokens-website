            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.sent();
                            idRefreshToken = headers.get("st-id-refresh-token");
                            if (!idRefreshToken) return [3 /*break*/, 5];
                            (0,
                        ...
                        case 7:
                            if (!(status_1 === fetch_1.default.config.invalidClaimStatusCode)) return [3 /*break*/, 9];
                            return [
                                4 /*yield*/,
                        ...
                        case 9:
                            ...
                            if (!antiCsrfToken) return [3 /*break*/, 12];
                            return [4 /*yield*/, (0, fetch_1.getIdRefreshToken)(true)];
                        case 10:
                            tok = _a.sent();
                            if (!(tok.status === "EXISTS")) return [3 /*break*/, 12];
                        ...
                        case 12:
                            ...
                            if (!frontToken) return [3 /*break*/, 14];
                            (0,
                        ...
                        case 16:
                            if (!!(_a.sent().status === "EXISTS")) return [3 /*break*/, 19];
                            (0,
                        ...
                        case 21:
                            ...
                            if (!(err_1.status !== undefined)) return [3 /*break*/, 23];
                                ...
                                if (
                                    ...
                                    (0, logger_1.logDebugMessage)(
                                        "XHRInterceptor.send: Adding st-auth-mode header: " +
                                            fetch_1.default.config.tokenTransferMethod
                                    );
                                    xhr.setRequestHeader("st-auth-mode", fetch_1.default.config.tokenTransferMethod);
                                } else {
                                    (0, logger_1.logDebugMessage)(
...
function saveTokensFromHeaders(headers) {
    return __awaiter(this, void 0, void 0, function() {
        var refreshToken, _a, value, expiry, accessToken, _b, value, expiry;
