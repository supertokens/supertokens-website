...
function addInterceptorsToXMLHttpRequest() {
    ...
    XMLHttpRequest = function() {
        ...
        actual.onreadystatechange = function(ev) {
        ...
        function handleResponse() {
            return __awaiter(this, void 0, void 0, function() {
                var status_1, idRefreshToken, antiCsrfToken, tok, frontToken, err_1, event_1;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            status_1 = actual.status;
                            idRefreshToken = actual.getResponseHeader("id-refresh-token");
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 10];
                        case 5:
                            antiCsrfToken = actual.getResponseHeader("anti-csrf");
                            if (!antiCsrfToken) return [3 /*break*/, 8];
                            return [4 /*yield*/, (0, fetch_1.getIdRefreshToken)(true)];
                        case 6:
                            tok = _a.sent();
                            if (!(tok.status === "EXISTS")) return [3 /*break*/, 8];
                        ...
                        case 7:
                            ...
                            _a.label = 8;
                        case 8:
                            frontToken = actual.getResponseHeader("front-token");
                            if (!frontToken) return [3 /*break*/, 10];
                        ...
                        case 11:
                            return [4 /*yield*/, (0, fetch_1.getIdRefreshToken)(true)];
                        case 12:
                            if (!!(_a.sent().status === "EXISTS")) return [3 /*break*/, 15];
                            (0,
