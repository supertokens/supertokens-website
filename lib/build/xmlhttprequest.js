                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0,
                            logger_1.logDebugMessage)("XHRInterceptor.handleRetryPostRefreshing: preRequestIdToken " + preRequestLSS.status);
                    ...
                    return __generator(this, function(_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, fetch_1.AntiCsrfToken.getToken(preRequestLSS.lastRefreshAttempt)];
                            case 2:
                            ...
                            case 3:
                                ...
                                return [4 /*yield*/, setTokenHeadersIfRequired(xhr, requestHeaders)];
                            case 4:
                                _a.sent();
...
function setTokenHeadersIfRequired(xhr, requestHeaders) {
    return __awaiter(this, void 0, void 0, function() {
        var transferMethod, accessToken;
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (
                        ...
                        (0, logger_1.logDebugMessage)(
                            "setTokenHeadersIfRequired: Adding st-auth-mode header: " + transferMethod
                        );
                        xhr.setRequestHeader("st-auth-mode", transferMethod);
                    } else {
                        (0, logger_1.logDebugMessage)(
                            "setTokenHeadersIfRequired: st-auth-mode header was already there in request"
                        );
                    }
                ...
                case 1:
                    ...
                    if (accessToken) {
                        if (
                            ...
                            (0, logger_1.logDebugMessage)(
                                "setTokenHeadersIfRequired: Authorization header defined by the user, not adding"
                            );
                        } else {
                        ...
                        (0, logger_1.logDebugMessage)(
                            "setTokenHeadersIfRequired: token for header based auth not found"
                        );
                    }
                    return [2 /*return*/];
            }
...
function saveTokensFromHeaders(headers) {
    return __awaiter(this, void 0, void 0, function() {
        var refreshToken, _a, value, expiry, accessToken, _b, value, expiry, frontToken, antiCsrfToken, tok;
        return __generator(this, function(_c) {
            switch (_c.label) {
                case 0:
                    ...
                    (_a = refreshToken.split(";")), (value = _a[0]), (expiry = _a[1]);
                ...
                case 2:
                    ...
                    (_b = accessToken.split(";")), (value = _b[0]), (expiry = _b[1]);
                ...
                case 4:
                    ...
                    if (!frontToken) return [3 /*break*/, 6];
                ...
                case 7:
                    ...
                    return [4 /*yield*/, fetch_1.AntiCsrfToken.setItem(tok.lastRefreshAttempt, antiCsrfToken)];
                case 8:
                    _c.sent();
                    _c.label = 9;
                case 9:
