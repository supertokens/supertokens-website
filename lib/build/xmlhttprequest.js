...
function addInterceptorsToXMLHttpRequest() {
    ...
    XMLHttpRequest = function() {
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 6:
                            if (!(status_1 < 400)) return [3 /*break*/, 12];
                        ...
                        case 13:
                            return [2 /*return*/, true];
                        case 14:
                            if (!doFinallyCheck) return [3 /*break*/, 18];
        ...
        function setUpXHR(self, xhr, isRetry) {
            ...
            for (var _i = 0, copiedProps_1 = copiedProps; _i < copiedProps_1.length; _i++) {
                var prop = copiedProps_1[_i];
                _loop_1(prop);
            }
        }
