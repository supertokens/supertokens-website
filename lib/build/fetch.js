 ...
 */
function handleUnauthorised(preRequestIdToken, transformErrorResponse) {
    return __awaiter(this, void 0, void 0, function() {
        var result;
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    if (!(result.result === "SESSION_EXPIRED")) return [3 /*break*/, 2];
                    return [2 /*return*/, false];
                case 2:
                    if (!(result.result === "API_ERROR")) return [3 /*break*/, 5];
                    if (!(result.error instanceof Response && transformErrorResponse !== undefined))
                        return [3 /*break*/, 4];
                    return [4 /*yield*/, transformErrorResponse(result.error)];
                case 3:
                    throw _a.sent();
                case 4:
                    throw result.error;
