...
function getIdRefreshToken() {
    var fromLocalstorage = AuthHttpRequest.crossDomainLocalstorage.getItem(ID_REFRESH_TOKEN_NAME);
...
function getAntiCSRFToken() {
    var fromLocalstorage = AuthHttpRequest.crossDomainLocalstorage.getItem(ANTI_CSRF_NAME);
    if (fromLocalstorage !== null) {
...
function getFrontToken() {
    var fromLocalstorage = AuthHttpRequest.crossDomainLocalstorage.getItem(FRONT_TOKEN_NAME);
    if (fromLocalstorage !== null) {
        return fromLocalstorage;
    }
    // for backwards compatibility
