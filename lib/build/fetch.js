...
exports.setFrontToken = exports.getFrontToken = exports.setAntiCSRF = exports.setIdRefreshToken = exports.getToken = exports.setToken = exports.getStorageNameForToken = exports.getIdRefreshToken = exports.onInvalidClaimResponse = exports.onTokenUpdate = exports.onUnauthorisedResponse = exports.FrontToken = exports.AntiCsrfToken = void 0;
...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(config, recipeImpl) {
        ...
        (0, logger_1.logDebugMessage)("init: Input sessionDomain: " + config.sessionDomain);
            ...
            return __generator(_a, function(_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, setTokenHeaders(clonedHeaders)];
                    case 8:
                        _b.sent();
                    ...
                    case 10:
                        _b.sent();
                        idRefreshToken = response.headers.get("st-id-refresh-token");
                    ...
                    case 16:
                        ...
                        if (!antiCsrfToken) return [3 /*break*/, 19];
                        return [4 /*yield*/, getIdRefreshToken(true)];
                    case 17:
                        tok = _b.sent();
                        if (!(tok.status === "EXISTS")) return [3 /*break*/, 19];
                    ...
                    case 19:
                        ...
                        if (!frontToken) return [3 /*break*/, 21];
                    ...
                    case 25:
                        ...
                        if (!(postRequestIdToken.status === "NOT_EXISTS")) return [3 /*break*/, 28];
                        (0,
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (antiCsrfToken_1 !== undefined) {
                        ...
                        headers.set("anti-csrf", antiCsrfToken_1);
                    }
                    _b.label = 6;
                case 6:
                    (0,
                    ...
                    return [4 /*yield*/, setTokenHeaders(headers, true)];
                case 7:
                    _b.sent();
                ...
                case 25:
                    ...
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 26:
                    if (!(_b.sent().status === "NOT_EXISTS")) return [3 /*break*/, 29];
                    (0,
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getToken("idRefresh")];
                case 1:
                    token = _b.sent();
                    if (token === "remove") {
...
function storeInCookies(name, value, expiry) {
    ...
    var domain = AuthHttpRequest.config.sessionScope;
    if (
        domain === "localhost" ||
...
function setTokenHeaders(clonedHeaders, addRefreshToken) {
    if (addRefreshToken === void 0) {
        addRefreshToken = false;
    }
    return __awaiter(this, void 0, void 0, function() {
        var idRefreshToken, accessToken, refreshToken;
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    if (!(AuthHttpRequest.config.tokenTransferMethod === "header")) return [3 /*break*/, 4];
                    (0, logger_1.logDebugMessage)("setTokenHeaders: adding ';header' to the rid header");
                ...
                case 1:
                    ...
                    if (idRefreshToken !== undefined) {
                        (0, logger_1.logDebugMessage)("setTokenHeaders: added st-id-refresh-token header");
                ...
                case 2:
                    ...
                    if (accessToken !== undefined) {
                        (0, logger_1.logDebugMessage)("setTokenHeaders: added authorization header");
                ...
                case 3:
                    ...
                    if (refreshToken && addRefreshToken) {
                        (0, logger_1.logDebugMessage)("setTokenHeaders: added st-refresh-token header");
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    expiry = idRefreshToken === "remove" ? 0 : Number.parseInt(idRefreshToken.split(";")[1]);
                    return [4 /*yield*/, setToken("idRefresh", idRefreshToken, expiry)];
                case 2:
                    _b.sent();
