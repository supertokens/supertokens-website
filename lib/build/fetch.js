...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(config, recipeImpl) {
        AuthHttpRequest.env =
            windowHandling_1.getWindowOrThrow().fetch === undefined ? global : windowHandling_1.getWindowOrThrow();
                        ...
                        return __generator(this, function(_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        cookieHandler_1.default.getInstanceOrThrow().cookieHandler.getCookie()
                                    ];
                                case 1:
                                    value = _a + _b.sent();
