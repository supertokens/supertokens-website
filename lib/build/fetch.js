        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4: return [2 /*return*/, AntiCsrfToken.tokenInfo.antiCsrf];
                }
            });
        });
    };
...
var FrontToken = /** @class */ (function () {
    ...
    FrontToken.getTokenInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getFrontToken()];
                    case 1:
                        frontToken = _a.sent();
                        if (frontToken === null) {
                            return [2 /*return*/, undefined];
    ...
    FrontToken.removeToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, setFrontToken(undefined)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FrontToken.setItem = function (frontToken) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, setFrontToken(frontToken)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
function handleUnauthorised(preRequestIdToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, onUnauthorisedResponse(preRequestIdToken)];
                case 1:
                    result = _a.sent();
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (options) {
        ...
        if (AuthHttpRequest.env.__supertokensOriginalFetch === undefined) {
            ...
            AuthHttpRequest.recipeImpl = config.override.functions(new recipeImplementation_1.default());
        }
        if (!AuthHttpRequest.addedFetchInterceptor) {
            AuthHttpRequest.addedFetchInterceptor = true;
            AuthHttpRequest.env.fetch = AuthHttpRequest.recipeImpl.addFetchInterceptorsAndReturnModifiedFetch(AuthHttpRequest.env.__supertokensOriginalFetch, config);
        }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        doNotDoInterception =
                            (typeof url === "string" &&
                                !utils_1.shouldDoInterceptionBasedOnUrl(url, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain) &&
                                AuthHttpRequest.addedFetchInterceptor) ||
                                (url !== undefined &&
                                    typeof url.url === "string" && // this is because url can be an object like {method: ..., url: ...}
                                    !utils_1.shouldDoInterceptionBasedOnUrl(url.url, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain) &&
                                    AuthHttpRequest.addedFetchInterceptor);
                    }
                    catch (err) {
                        if (err.message === "Please provide a valid domain name") {
                            ...
                            doNotDoInterception =
                                !utils_1.shouldDoInterceptionBasedOnUrl(window.location.origin, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain) && AuthHttpRequest.addedFetchInterceptor;
                        }
                        else {
                            throw err;
                        }
                ...
                case 3:
                    ...
                    _loop_1 = function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, getIdRefreshToken(true)];
                                case 1:
                                ...
                                case 5:
                                    response_1 = _a.sent();
                                    return [4 /*yield*/, loopThroughResponseHeadersAndApplyFunction(response_1, function (value, key) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        if (!(key.toString() === "id-refresh-token")) return [3 /*break*/, 2];
                                                        return [4 /*yield*/, setIdRefreshToken(value, response_1.status)];
                                                    case 1:
                                                        _a.sent();
                                                        _a.label = 2;
                                ...
                                case 6:
                                    _a.sent();
                                    if (!(response_1.status === AuthHttpRequest.config.sessionExpiredStatusCode)) return [3 /*break*/, 8];
                                ...
                                case 7:
                                    ...
                                    return [3 /*break*/, 10];
                                case 8: return [4 /*yield*/, loopThroughResponseHeadersAndApplyFunction(response_1, function (value, key) { return __awaiter(_this, void 0, void 0, function () {
                                        var tok;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                ...
                                case 11:
                                    err_1 = _a.sent();
                                    if (!(err_1.status === AuthHttpRequest.config.sessionExpiredStatusCode)) return [3 /*break*/, 13];
                                    return [4 /*yield*/, handleUnauthorised(preRequestIdToken)];
                                case 12:
                                    retry = _a.sent();
                                    if (!retry) {
                ...
                case 6:
                    ...
                    return [3 /*break*/, 12];
                case 7: return [4 /*yield*/, index_1.doesSessionExist()];
                case 8:
    ...
    AuthHttpRequest.attemptRefreshingSession = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3: return [4 /*yield*/, AuthHttpRequest.recipeImpl.doesSessionExist(AuthHttpRequest.config)];
                case 4:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _loop_2 = function () {
                        var postLockID, headers, antiCsrfToken, preAPIResult, response_2, removeIdRefreshToken_1, error_1, idCookieValue;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, lock.acquireLock("REFRESH_TOKEN_USE", 1000)];
                                case 1:
                                ...
                                case 3:
                                    ...
                                    if (postLockID.status !== preRequestIdToken.status ||
                                ...
                                case 4:
                                    ...
                                    _a.label = 5;
                                case 5:
                                    headers = __assign({ rid: AuthHttpRequest.rid }, headers, { "fdi-version": version_1.supported_fdi.join(",") });
                                ...
                                case 7:
                                    ...
                                    return [4 /*yield*/, loopThroughResponseHeadersAndApplyFunction(response_2, function (value, key) { return __awaiter(_this, void 0, void 0, function () {
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        if (!(key.toString() === "id-refresh-token")) return [3 /*break*/, 2];
                                                        return [4 /*yield*/, setIdRefreshToken(value, response_2.status)];
                                                    case 1:
                                                        _a.sent();
                                ...
                                case 8:
                                    _a.sent();
                                    if (!(response_2.status === AuthHttpRequest.config.sessionExpiredStatusCode)) return [3 /*break*/, 10];
                                ...
                                case 15:
                                    ...
                                    return [7 /*endfinally*/];
                                case 16: return [4 /*yield*/, getIdRefreshToken(false)];
                                case 17:
                                    ...
                                    if (idCookieValue.status === "NOT_EXISTS") {
                                        ...
                                        if (idCookieValue.status !== preRequestIdToken.status ||
...
function getIdRefreshToken(tryRefresh) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getIdRefreshTokenFromLocal()];
                case 1:
                    token = _a.sent();
                    if (token === "remove") {
                        return [2 /*return*/, {
                ...
                case 5: return [4 /*yield*/, getIdRefreshToken(tryRefresh)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        function setIDToCookie(idRefreshToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                utils_1.getWindowOrThrow().document.cookie = ID_REFRESH_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
            }
            else {
                utils_1.getWindowOrThrow().document.cookie = ID_REFRESH_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
            }
        }
        var status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getIdRefreshToken(false)];
                case 1:
...
function getAntiCSRFToken() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, AuthHttpRequest.recipeImpl.doesSessionExist(AuthHttpRequest.config)];
                case 1:
                    if (!(_a.sent())) {
        ...
        function setAntiCSRFToCookie(antiCSRFToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
            }
            else {
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";domain=" + domain + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
            }
        }
        return __generator(this, function (_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        function setFrontTokenToCookie(frontToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                // see https://github.com/supertokens/supertokens-website/issues/25
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
            }
            else {
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";domain=" + domain + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.config.isInIframe ? "none;secure" : "lax");
                }
            }
        }
        return __generator(this, function (_a) {
