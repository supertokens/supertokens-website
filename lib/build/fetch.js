    ...
    AntiCsrfToken.getToken = function(associatedIdRefreshToken) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logDebugMessage("AntiCsrfToken.getToken: called");
                        if (associatedIdRefreshToken === undefined) {
                            AntiCsrfToken.tokenInfo = undefined;
                            logger_1.logDebugMessage("AntiCsrfToken.getToken: returning undefined");
                    ...
                    case 4:
                        logger_1.logDebugMessage(
                            "AntiCsrfToken.getToken: returning: " + AntiCsrfToken.tokenInfo.antiCsrf
                        );
    ...
    AntiCsrfToken.removeToken = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logDebugMessage("AntiCsrfToken.removeToken: called");
                        AntiCsrfToken.tokenInfo = undefined;
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.logDebugMessage("AntiCsrfToken.setItem: called");
    ...
    FrontToken.getTokenInfo = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logDebugMessage("FrontToken.getTokenInfo: called");
                    ...
                    case 5:
                        ...
                        logger_1.logDebugMessage("FrontToken.getTokenInfo: returning ate: " + response.ate);
                        logger_1.logDebugMessage("FrontToken.getTokenInfo: returning uid: " + response.uid);
                        logger_1.logDebugMessage("FrontToken.getTokenInfo: returning up: " + response.up);
    ...
    FrontToken.removeToken = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logDebugMessage("FrontToken.removeToken: called");
    ...
    FrontToken.setItem = function(frontToken) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.logDebugMessage("FrontToken.setItem: called");
...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(config, recipeImpl) {
        logger_1.logDebugMessage("init: called");
        logger_1.logDebugMessage("init: Input apiBasePath: " + config.apiBasePath);
        logger_1.logDebugMessage("init: Input apiDomain: " + config.apiDomain);
        logger_1.logDebugMessage("init: Input autoAddCredentials: " + config.autoAddCredentials);
        logger_1.logDebugMessage("init: Input cookieDomain: " + config.cookieDomain);
        logger_1.logDebugMessage("init: Input isInIframe: " + config.isInIframe);
        logger_1.logDebugMessage("init: Input sessionExpiredStatusCode: " + config.sessionExpiredStatusCode);
        logger_1.logDebugMessage("init: Input sessionScope: " + config.sessionScope);
        ...
        if (AuthHttpRequest.env.__supertokensOriginalFetch === undefined) {
            logger_1.logDebugMessage("init: __supertokensOriginalFetch is undefined");
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        logger_1.logDebugMessage("doRequest: start of fetch interception");
                    ...
                    case 7:
                        ...
                        if (!clonedHeaders.has("rid")) {
                            logger_1.logDebugMessage("doRequest: Adding rid header: anti-csrf");
                            clonedHeaders.set("rid", "anti-csrf");
                        } else {
                            logger_1.logDebugMessage("doRequest: rid header was already there in request");
                        }
                    ...
                    case 22:
                        ...
                        if (!(postRequestIdToken.status === "NOT_EXISTS")) return [3 /*break*/, 25];
                        logger_1.logDebugMessage(
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    logger_1.logDebugMessage("onUnauthorisedResponse: trying to acquire lock");
                    return [4 /*yield*/, lock.acquireLock("REFRESH_TOKEN_USE", 1000)];
                case 2:
                    if (!_a.sent()) return [3 /*break*/, 29];
                    logger_1.logDebugMessage("onUnauthorisedResponse: lock acquired");
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 21, 23, 29]);
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 4:
                    postLockID = _a.sent();
                ...
                case 5:
                    ...
                    if (antiCsrfToken_1 !== undefined) {
                        logger_1.logDebugMessage("onUnauthorisedResponse: Adding anti-csrf token to refresh API call");
                        headers = __assign(__assign({}, headers), { "anti-csrf": antiCsrfToken_1 });
                    }
                    _a.label = 6;
                case 6:
                    logger_1.logDebugMessage(
                        "onUnauthorisedResponse: Adding rid and fdi-versions to refresh call header"
                    );
                    headers = __assign(__assign({ rid: AuthHttpRequest.rid }, headers), {
                        "fdi-version": version_1.supported_fdi.join(",")
                    });
                    logger_1.logDebugMessage("onUnauthorisedResponse: Calling refresh pre API hook");
                    return [
                        4 /*yield*/,
                ...
                case 7:
                    ...
                    logger_1.logDebugMessage("onUnauthorisedResponse: Making refresh call");
                    return [
                        4 /*yield*/,
                ...
                case 10:
                    ...
                    logger_1.logDebugMessage("onUnauthorisedResponse: Refresh call ended");
                    removeIdRefreshToken = true;
                    idRefreshToken = response.headers.get("id-refresh-token");
                    if (!idRefreshToken) return [3 /*break*/, 12];
                    logger_1.logDebugMessage(
                ...
                case 12:
                    ...
                    if (!removeIdRefreshToken) return [3 /*break*/, 14];
                ...
                case 15:
                    ...
                    antiCsrfToken = response.headers.get("anti-csrf");
                    if (!antiCsrfToken) return [3 /*break*/, 18];
                    return [4 /*yield*/, getIdRefreshToken(true)];
                case 16:
                    tok = _a.sent();
                    if (!(tok.status === "EXISTS")) return [3 /*break*/, 18];
                    logger_1.logDebugMessage("onUnauthorisedResponse: setting anti-csrf token");
                    return [4 /*yield*/, AntiCsrfToken.setItem(tok.token, antiCsrfToken)];
                case 17:
                    _a.sent();
                    _a.label = 18;
                case 18:
                    frontToken = response.headers.get("front-token");
                    if (!frontToken) return [3 /*break*/, 20];
                    logger_1.logDebugMessage("onUnauthorisedResponse: setting sFrontToken: " + frontToken);
                    return [4 /*yield*/, FrontToken.setItem(frontToken)];
                case 19:
                    _a.sent();
                    _a.label = 20;
                case 20:
                    ...
                    logger_1.logDebugMessage("onUnauthorisedResponse: Sending RETRY signal");
                    return [2 /*return*/, { result: "RETRY" }];
                case 21:
                    error_2 = _a.sent();
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 22:
                    if (_a.sent().status === "NOT_EXISTS") {
                        ...
                        // means that the frontend did not know for sure that the session existed
                        // in the first place.
                        return [2 /*return*/, { result: "SESSION_EXPIRED", error: error_2 }];
                    }
                    logger_1.logDebugMessage("onUnauthorisedResponse: sending API_ERROR");
                    return [2 /*return*/, { result: "API_ERROR", error: error_2 }];
                case 23:
                    return [4 /*yield*/, lock.releaseLock("REFRESH_TOKEN_USE")];
                case 24:
                    _a.sent();
                    logger_1.logDebugMessage("onUnauthorisedResponse: Released lock");
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 25:
                    if (!(_a.sent().status === "NOT_EXISTS")) return [3 /*break*/, 28];
                    logger_1.logDebugMessage(
...
function onTokenUpdate() {
    logger_1.logDebugMessage("onTokenUpdate: firing ACCESS_TOKEN_PAYLOAD_UPDATED event");
    AuthHttpRequest.config.onHandleEvent({
...
function getIdRefreshToken(tryRefresh) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("getIdRefreshToken: called");
                    return [4 /*yield*/, getIdRefreshTokenFromLocal()];
                case 1:
                    token = _a.sent();
                    if (token === "remove") {
                        logger_1.logDebugMessage("getIdRefreshToken: is removed");
                        return [
                            2 /*return*/,
                            {
                                status: "NOT_EXISTS"
                    ...
                    logger_1.logDebugMessage("getIdRefreshToken: is undefined");
                    response = {
                        status: "MAY_EXIST"
                    };
                    if (!tryRefresh) return [3 /*break*/, 4];
                    logger_1.logDebugMessage("getIdRefreshToken: trying to refresg");
                    return [4 /*yield*/, onUnauthorisedResponse(response)];
                case 2:
                    res = _a.sent();
                    if (res.result !== "RETRY") {
                        logger_1.logDebugMessage("getIdRefreshToken: false NOT_EXISTS in case error from backend");
                    ...
                    logger_1.logDebugMessage("getIdRefreshToken: Retrying post refresh");
                    return [4 /*yield*/, getIdRefreshToken(tryRefresh)];
                case 3:
                    return [2 /*return*/, _a.sent()];
                case 4:
                    logger_1.logDebugMessage("getIdRefreshToken: returning: " + response.status);
                    return [2 /*return*/, response];
                case 5:
                    logger_1.logDebugMessage("getIdRefreshToken: returning EXISTS: " + token);
                    return [
                        2 /*return*/,
                        {
                            status: "EXISTS",
...
function setIdRefreshToken(idRefreshToken, statusCode) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("setIdRefreshToken: called");
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 1:
                    status = _a.sent().status;
                    logger_1.logDebugMessage("setIdRefreshToken: setting: " + idRefreshToken);
                ...
                case 2:
                    ...
                    if (idRefreshToken === "remove" && status === "EXISTS") {
                        ...
                        if (statusCode === AuthHttpRequest.config.sessionExpiredStatusCode) {
                            logger_1.logDebugMessage("setIdRefreshToken: firing UNAUTHORISED event");
                            AuthHttpRequest.config.onHandleEvent({
                                action: "UNAUTHORISED",
                            ...
                            logger_1.logDebugMessage("setIdRefreshToken: firing SIGN_OUT event");
                            AuthHttpRequest.config.onHandleEvent({
                                action: "SIGN_OUT",
                                userContext: {}
                            });
                    ...
                    if (idRefreshToken !== "remove" && status === "NOT_EXISTS") {
                        logger_1.logDebugMessage("setIdRefreshToken: firing SESSION_CREATED event");
                        AuthHttpRequest.config.onHandleEvent({
...
function getAntiCSRFToken() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("getAntiCSRFToken: called");
                    return [4 /*yield*/, getIdRefreshToken(true)];
                case 1:
                    ...
                    if (!(_a.sent().status === "EXISTS")) {
                        logger_1.logDebugMessage("getAntiCSRFToken: Returning because sIRTFrontend != EXISTS");
                        return [2 /*return*/, null];
                    }
                    return [4 /*yield*/, getAntiCSRFromCookie()];
                case 2:
                    fromCookie = _a.sent();
                    logger_1.logDebugMessage("getAntiCSRFToken: returning: " + fromCookie);
                    return [2 /*return*/, fromCookie];
            }
        });
    });
...
function setAntiCSRF(antiCSRFToken) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("setAntiCSRF: called: " + antiCSRFToken);
...
function getFrontTokenFromCookie() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    logger_1.logDebugMessage("getFrontTokenFromCookie: called");
                    _a = "; ";
...
function getFrontToken() {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("getFrontToken: called");
                    return [4 /*yield*/, getIdRefreshToken(true)];
                case 1:
                    // we do not call doesSessionExist here cause the user might override that
                    // function here and then it may break the logic of our original implementation.
                    if (!(_a.sent().status === "EXISTS")) {
                        logger_1.logDebugMessage("getFrontToken: Returning because sIRTFrontend != EXISTS");
                        return [2 /*return*/, null];
                    }
                    return [4 /*yield*/, getFrontTokenFromCookie()];
                case 2:
                    fromCookie = _a.sent();
                    logger_1.logDebugMessage("getFrontToken: returning: " + fromCookie);
                    return [2 /*return*/, fromCookie];
            }
        });
    });
...
function setFrontToken(frontToken) {
    return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logDebugMessage("setFrontToken: called");
                    return [4 /*yield*/, getFrontTokenFromCookie()];
                case 1:
                    oldToken = _a.sent();
