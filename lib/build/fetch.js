...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (config, recipeImpl) {
        ...
        try {
            ...
            windowHandler_1.default.getReferenceOrThrow().windowHandler.getWindowUnsafe();
            (0, logger_1.logDebugMessage)(
                "init: Input sessionTokenFrontendDomain: " + config.getSessionTokenFrontendDomain()
            );
            fetchedWindow = windowHandler_1.default.getReferenceOrThrow().windowHandler.getWindowUnsafe();
        } catch (_) {}
...
function storeInCookies(name, value, expiry) {
    ...
    var domain = AuthHttpRequest.config.getSessionTokenFrontendDomain();
    if (
        domain === "localhost" ||
