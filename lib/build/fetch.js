                ...
                switch (_b.label) {
                    ...
                    case 12:
                        if (!(response.status === AuthHttpRequest.config.invalidClaimStatusCode))
                            return [3 /*break*/, 14];
                        _a = onInvalidClaimResponse;
                        return [4 /*yield*/, AuthHttpRequest.recipeImpl.getInvalidClaimsFromResponse(response)];
                    case 13:
        ...
        return __generator(this, function(_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    if (!removeIdRefreshToken) return [3 /*break*/, 13];
                ...
                case 23:
                    ...
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 24:
                    if (!(_a.sent().status === "NOT_EXISTS")) return [3 /*break*/, 27];
                    logger_1.logDebugMessage(
...
function onInvalidClaimResponse(claimValidationErrors) {
    AuthHttpRequest.config.onHandleEvent({
