...
var AntiCsrfToken = /** @class */ (function() {
    ...
    AntiCsrfToken.getToken = function(associatedRefreshAttempt) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        AntiCsrfToken.tokenInfo = {
                            antiCsrf: antiCsrf,
                            associatedRefreshAttempt: associatedRefreshAttempt
                        };
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(AntiCsrfToken.tokenInfo.associatedRefreshAttempt !== associatedRefreshAttempt))
                            return [3 /*break*/, 4];
                        // csrf token has changed.
                        AntiCsrfToken.tokenInfo = undefined;
                        return [4 /*yield*/, AntiCsrfToken.getToken(associatedRefreshAttempt)];
                    case 3:
    ...
    AntiCsrfToken.setItem = function(associatedRefreshAttempt, antiCsrf) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
...
function onUnauthorisedResponse(preRequestLSS) {
    return __awaiter(this, void 0, void 0, function() {
        var lock, postLockLSS, headers, antiCsrfToken, preAPIResult, response, isUnauthorised, error_1, postRequestLSS;
...
function setAuthorizationHeaderIfRequired(clonedHeaders, addRefreshToken) {
    ...
    return __awaiter(this, void 0, void 0, function() {
        var transferMethod, token;
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    transferMethod = AuthHttpRequest.config.tokenTransferMethod;
                    (0,
                    logger_1.logDebugMessage)("setAuthorizationHeaderIfRequired: Adding st-auth-mode header: " + transferMethod);
                    clonedHeaders.set("st-auth-mode", transferMethod);
                    (0, logger_1.logDebugMessage)("setTokenHeaders: adding existing tokens as header");
                    return [4 /*yield*/, getTokenForHeaderAuth(addRefreshToken ? "refresh" : "access")];
                case 1:
                    token = _b.sent();
                    if (token) {
                        ...
                        if (clonedHeaders.has("Authorization")) {
                            ...
                            if (token !== undefined) {
                                ...
                                clonedHeaders.set("Authorization", "Bearer ".concat(token));
                            }
                        }
                    } else {
                        (0, logger_1.logDebugMessage)(
