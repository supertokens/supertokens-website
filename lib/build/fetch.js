...
function onUnauthorisedResponse(preRequestIdToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    return [4 /*yield*/, lockFactory_1.LockFactoryReference.getReferenceOrThrow().lockFactory()];
                case 1:
                    lock = _b.sent();
                    _b.label = 2;
                case 2:
                ...
                case 24:
                    ...
                    return [4 /*yield*/, getIdRefreshToken(false)];
                case 25:
                    if (!(_b.sent().status === "NOT_EXISTS")) return [3 /*break*/, 28];
                    (0,
