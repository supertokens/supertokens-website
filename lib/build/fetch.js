        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    ...
                    (0, logger_1.logDebugMessage)("setTokenHeadersIfRequired: adding ';header' to the rid header");
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        setAntiCSRFToCookie(antiCSRFToken, AuthHttpRequest.config.sessionTokenFrontendDomain)
                    ];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
        ...
        return __generator(this, function(_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/,
                        setFrontTokenToCookie(frontToken, AuthHttpRequest.config.sessionTokenFrontendDomain)
                    ];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
