...
var AuthHttpRequest = /** @class */ (function() {
    ...
    AuthHttpRequest.init = function(config, recipeImpl) {
        ...
        AuthHttpRequest.cookieHandler = utils_1.normaliseCookieHandler(config.cookieHandler);
                        ...
                        try {
                            ...
                            if (err.message === "Please provide a valid domain name") {
                                ...
                                doNotDoInterception = !utils_1.shouldDoInterceptionBasedOnUrl(
                                    windowUtils_1.WindowUtilities.location.origin,
                                    AuthHttpRequest.config.apiDomain,
                                    AuthHttpRequest.config.cookieDomain
                                );
                            } else {
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = "; ";
                                    return [4 /*yield*/, AuthHttpRequest.cookieHandler.getCookie()];
                                case 1:
                                    value = _a + _b.sent();
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(domain === "localhost" || domain === windowUtils_1.WindowUtilities.location.hostname))
                                return [3 /*break*/, 2];
                            ...
                            return [
                                4 /*yield*/,
                                AuthHttpRequest.cookieHandler.setCookie(
