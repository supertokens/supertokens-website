        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        FrontToken.waiters.forEach(function (f) { return f(undefined); });
                        FrontToken.waiters = [];
                        return [2 /*return*/];
                }
            });
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.doRequest = function (httpCall, config, url) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    try {
                        doNotDoInterception =
                            (typeof url === "string" &&
                                !(0, utils_1.shouldDoInterceptionBasedOnUrl)(url, AuthHttpRequest.config.apiDomain, AuthHttpRequest.config.cookieDomain)) ||
                                (url !== undefined &&
                ...
                case 7:
                    if (AuthHttpRequest.config.autoAddCredentials) {
                        ...
                        if (configWithAntiCsrf === undefined) {
                            ...
                            configWithAntiCsrf = __assign(__assign({}, configWithAntiCsrf), { credentials: "include" });
                        }
                    }
                ...
                case 22: return [4 /*yield*/, getIdRefreshToken(false)];
                case 23:
    ...
    AuthHttpRequest.attemptRefreshingSession = function () { return __awaiter(void 0, void 0, void 0, function () {
...
function onUnauthorisedResponse(preRequestIdToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    lock = lockFactory_1.LockFactoryReference.getReferenceOrThrow().lockFactory();
                    _b.label = 1;
                case 1:
                ...
                case 6:
                    ...
                    headers = __assign(__assign({ rid: AuthHttpRequest.rid }, headers), { "fdi-version": version_1.supported_fdi.join(",") });
                ...
                case 22: return [4 /*yield*/, lock.releaseLock("REFRESH_TOKEN_USE")];
                case 23:
                    _b.sent();
                ...
                case 28: return [4 /*yield*/, getIdRefreshToken(false)];
                case 29:
    ...
    return __awaiter(this, void 0, void 0, function () {
        function getIdRefreshTokenFromLocal() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, getIDFromCookieOld()];
                        case 1:
                            fromCookie = _b.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(domain === "localhost" ||
                                domain === windowHandler_1.default.getReferenceOrThrow().windowHandler.location.getHostName())) return [3 /*break*/, 2];
                        ...
                        case 1:
                            ...
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, cookieHandler_1.default.getReferenceOrThrow().cookieHandler.setCookie("".concat(ID_REFRESH_TOKEN_NAME, "=").concat(cookieVal, ";expires=").concat(expires, ";domain=").concat(domain, ";path=/;samesite=").concat(AuthHttpRequest.config.isInIframe ? "none;secure" : "lax"))];
                        case 3:
                            _b.sent();
                            _b.label = 4;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(domain === "localhost" ||
                                domain === windowHandler_1.default.getReferenceOrThrow().windowHandler.location.getHostName())) return [3 /*break*/, 5];
                        ...
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, cookieHandler_1.default.getReferenceOrThrow().cookieHandler.setCookie("".concat(ANTI_CSRF_NAME, "=").concat(cookieVal, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=").concat(AuthHttpRequest.config.isInIframe ? "none;secure" : "lax"))];
                        case 3:
                            _b.sent();
                            _b.label = 4;
                        ...
                        case 6:
                            _b.sent();
                            return [3 /*break*/, 9];
                        case 7: return [4 /*yield*/, cookieHandler_1.default.getReferenceOrThrow().cookieHandler.setCookie("".concat(ANTI_CSRF_NAME, "=").concat(cookieVal, ";domain=").concat(domain, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=").concat(AuthHttpRequest.config.isInIframe ? "none;secure" : "lax"))];
                        case 8:
                            _b.sent();
                            _b.label = 9;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, cookieHandler_1.default.getReferenceOrThrow().cookieHandler.setCookie("".concat(FRONT_TOKEN_NAME, "=").concat(cookieVal, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=").concat(AuthHttpRequest.config.isInIframe ? "none;secure" : "lax"))];
                        case 3:
                            _b.sent();
                            _b.label = 4;
                        case 4: return [3 /*break*/, 9];
                        ...
                        case 6:
                            _b.sent();
                            return [3 /*break*/, 9];
                        case 7: return [4 /*yield*/, cookieHandler_1.default.getReferenceOrThrow().cookieHandler.setCookie("".concat(FRONT_TOKEN_NAME, "=").concat(cookieVal, ";domain=").concat(domain, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=").concat(AuthHttpRequest.config.isInIframe ? "none;secure" : "lax"))];
                        case 8:
                            _b.sent();
                            _b.label = 9;
                        case 9: return [2 /*return*/];
