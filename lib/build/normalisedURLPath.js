...
var NormalisedURLPath = /** @class */ (function() {
    function NormalisedURLPath(url) {
        ...
        this.equals = function(other) {
            return _this.value === other.value;
        };
        this.isARecipePath = function() {
            return _this.value === "/recipe" || _this.value.startsWith("/recipe/");
        };
...
function normaliseURLPathOrThrowError(input) {
    ...
    try {
        ...
        var urlObj = new url_1.URL(input);
...
function domainGiven(input) {
    ...
    try {
        var url = new url_1.URL("http://" + input);
        return url.hostname.indexOf(".") !== -1;
    } catch (ignored) {}
    return false;
}
